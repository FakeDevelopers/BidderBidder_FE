      ...
      <div class="wrapper">
          ...
          <div class="bdbd-login">
            <form v-on:submit.prevent="submitForm">
              ...
              <div class="remember-me">
                <input type="checkbox" id="automatic-login" value="true"><label
                  for="automatic-login">{{ $t('automaticLogin') }}</label>
              </div>
        ...
        <div class="footer">
          <div class="signup-cta">
            ...
            <a href="" class="button button__link__primary" v-if="$i18n.locale === 'ko'">{{
                $t('signup') + $t('do')
              }}</a>
