    ...
    <div class="header">
      <div class="top-nav">
        ...
        <g clip-path="url(#clip0_16_254)">
          <path d="M20.6338 0H3.3662C1.5071 0 0 1.5071 0 3.3662V20.6338C0 22.4929 1.5071 24 3.3662 24H20.6338C22.4929 24 24 22.4929 24 20.6338V3.3662C24 1.5071 22.4929 0 20.6338 0Z" fill="#38BBF3"/>
          ...
          <path d="M12.5133 19.3748L13.4235 18.2006C13.9308 17.5382 13.0526 16.8232 12.5089 17.3948C12.0333 17.9973 10.9807 19.329 10.5125 19.9177L12.5015 22.338L13.5905 22.5313L14.3216 22.0257" fill="#38BBF3"/>
          ...
          <path d="M13.3749 23.9779C13.7091 23.7503 13.9885 23.4514 14.2063 23.1107C14.3555 22.8778 14.5433 22.5842 14.5433 22.5842C14.8755 21.944 14.1249 21.3785 13.6307 21.8726" fill="#38BBF3"/>
          <path d="M9.36996 22.4782C9.18482 21.9312 9.19593 21.3161 9.35212 20.8324L9.57295 20.1952C9.66484 19.8572 9.62714 19.4126 9.61873 19.0625L9.48341 17.2016C9.47398 16.8125 9.76852 16.4735 10.157 16.4503C10.565 16.4257 10.9087 16.7445 10.9184 17.1495L11.1126 19.836L14.356 22.6976L13.3751 23.9785L10.5121 24.0004" fill="#38BBF3"/>
          ...
          <path d="M12.8478 20.7982L13.7022 19.7819C14.2041 19.1881 13.3861 18.3964 12.8401 18.9885L12.3638 19.5678" fill="#38BBF3"/>
          ...
          <path d="M13.4837 22.0742L14.0496 21.2993C14.1068 21.2209 14.1499 21.1323 14.1687 21.0371C14.3007 20.4403 13.5282 19.9986 13.1067 20.4901L12.8236 20.823" fill="#38BBF3"/>
          ...
          <path d="M7 9V15H8.65892V9" stroke="#38BBF3" stroke-width="0.996678" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M10.7708 9V15" stroke="#38BBF3" stroke-width="0.996678" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M14.7673 9H13.1527V15L15.2363 14.5698" stroke="#38BBF3" stroke-width="0.996678" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M15.5891 11.8694L16.8842 12.0111" stroke="#38BBF3" stroke-width="0.996678" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M7.18164 12.0111L8.47677 12.1534" stroke="#38BBF3" stroke-width="0.996678" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M16.8842 9V15" stroke="#38BBF3" stroke-width="0.996678" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
        <defs>
